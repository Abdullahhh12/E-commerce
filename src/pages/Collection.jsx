  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-5 border-t'>
      ...
      <div className='min-w-60'>
        ...
        {/* subcategory */}
        <div className={`border border-gray-300 pl-5 py-3 my-6 sm:block ${showFilter ?'':'hidden'}`}>
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between text-lg sm:text-2xl mb-4'>
          ...
          {/* products sort */}
          <select onChange={(e)=>setsortType(e.target.value)} className='border-2 lg:w-3/2 border-gray-300 text-sm ' >
